import{d as u,b as h,o as d,e as n,w as a,a as l,f as S,n as r,g,T as c,r as f,h as i,i as w}from"./iframe-9M950ORq.js";import{_ as v}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-DUEg7uLd.js";const m=u({__name:"BottomSheet",props:{isShow:{type:Boolean}},setup(e){return(t,s)=>(d(),h(c,{name:"appear"},{default:n(()=>[a(l("div",{class:r(t.$style.overlay),onClick:s[0]||(s[0]=S(k=>t.$emit("close"),["self"]))},[g(c,{name:"slide-up"},{default:n(()=>[a(l("div",{class:r(t.$style.sheet)},[f(t.$slots,"default")],2),[[i,e.isShow]])]),_:3})],2),[[i,e.isShow]])]),_:3}))}}),_="_overlay_1te5n_1",B="_sheet_1te5n_11",y={overlay:_,sheet:B},b={$style:y},p=v(m,[["__cssModules",b]]);m.__docgenInfo={exportName:"default",displayName:"BottomSheet",description:"",tags:{},props:[{name:"isShow",required:!0,type:{name:"boolean"}}],events:[{name:"close"}],slots:[{name:"default"}],sourceFiles:["/home/runner/work/components-expansion/components-expansion/src/components/molecules/BottomSheet.vue"]};const N={title:"Components/molecules/BottomSheet",component:p},o={render:()=>({components:{BottomSheet:p},setup(){const e=w(!0);return{isShow:e,toggle:()=>e.value=!e.value}},template:`
